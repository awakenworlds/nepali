...
    function updateTracker() {
        // MODIFIED: Using a table for perfect columnar alignment of scores
...
    // MODIFIED (from previous request): Only disable the 'Submit' buttons, allowing 'Reveal' to remain active.
